...
def helpMessage() {
    ...
    Options:
     ...
     --whitelist [file]                 Path to the file that is the complement of blacklist, needed for SNP extraction. This file can be generated if a blacklist is provided.
     --blacklist [file]                 Path to the file with problematic regions of the genome
