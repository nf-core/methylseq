     ...
     */
     ...
     if( params.merge ) {
	    ...
	    tag "${params.name}"
            ...
            output:
            set val(params.name), file("*.merged.bam") into ch_bam_for_bismark_deduplicate, ch_bam_for_preseq
        ...
        ch_bam_for_merge_pass.into{ch_bam_for_bismark_deduplicate; ch_bam_for_preseq}
     }
