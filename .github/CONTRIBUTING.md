...
We try to manage the required tasks for nf-core/methylseq using GitHub issues, you probably came to this page when creating one.
...
For further information/help, please consult the [nf-core/methylseq documentation](https://nf-co.re/nf-core/methylseq/docs) and don't hesitate to get in touch on the nf-core Slack [#methylseq](https://nfcore.slack.com/channels/methylseq) channel ([join our Slack here](https://nf-co.re/join/slack)).
