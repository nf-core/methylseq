...
[![AWS CI](https://img.shields.io/badge/CI%20tests-full%20size-FF9900?labelColor=000000&logo=Amazon%20AWS)](https://nf-co.re/methylseq/results)[![Cite with Zenodo](http://img.shields.io/badge/DOI-10.5281/zenodo.XXXXXXX-1073c8?labelColor=000000)](https://doi.org/10.5281/zenodo.XXXXXXX)
...
**nf-core/methylseq** is a bioinformatics best-practice analysis pipeline for Methylation (Bisulfite-Sequencing) Best Practice analysis pipeline, part of the nf-core community..
...
The nf-core/methylseq pipeline comes with documentation about the pipeline [usage](https://nf-co.re/methylseq/usage), [parameters](https://nf-co.re/methylseq/parameters) and [output](https://nf-co.re/methylseq/output).
