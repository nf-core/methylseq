...
## [v4.1.0](https://github.com/nf-core/methylseq/releases/tag/4.0.0) - []

### Bug fixes & refactoring

- 🐛 Fix bug where fastqc output is added to multiqc_ch twice [#546](https://github.com/nf-core/methylseq/pull/548)
